package br.org.generation.sustentei.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		...
		.basePackage("br.org.generation.sustentei.controller"))
	...
	public static ApiInfo metadata() {
		...
		return new ApiInfoBuilder()
			...
			.licenseUrl("https://github.com/SustenteiGen")
			.contact(contact())
			.build();
	}
	...
	private static Contact contact() {
		...
		return new Contact("</Sustentei>", 
			"https://github.com/SustenteiGen", 
			"sustenteiprojeto@gmail.com");
